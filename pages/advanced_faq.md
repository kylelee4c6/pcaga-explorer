...
* **Generation**: The application uses **OpenAI’s gpt-5-mini** model for generating responses based on retrieved context. Model selection can be swapped via environment configuration if needed.
